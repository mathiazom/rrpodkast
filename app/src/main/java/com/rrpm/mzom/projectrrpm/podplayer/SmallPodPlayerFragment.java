...
public class SmallPodPlayerFragment extends Fragment {
    ...
    private static final String TAG = "RRP-SmallPodPlayerFragment";
    ...
    @NonNull
    public static SmallPodPlayerFragment newInstance(@NonNull MainFragmentsHandler mainFragmentsHandler) {

        final SmallPodPlayerFragment fragment = new SmallPodPlayerFragment();
